...
load('C:\Users\marco\projects\TCC\main\Results\30ns\NonLinear\NonLinear_4QAM_16Cp.mat');
...
load('C:\Users\marco\projects\TCC\main\Results\30ns\NonLinear\NonLinear_4QAM_8Cp.mat');
semilogy(EbNOdB(snrValues),LS_SER(snrValues),'--','Color', ["#2d3047"],'LineWidth',2.0);
hold on;
semilogy(EbNOdB(snrValues),LMMSE_SER(snrValues),'--','Color', ["#c4253b"],'LineWidth',2.0);
hold on;
...
matlab2tikz('IntermediaryNonLinear_4QAM.tex')