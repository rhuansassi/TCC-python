...
% SCFNN
load('C:\Users\marco\projects\TCC\main\Results\Convergence\Conv_Linear_64QAM_16Cp.mat');
Y1 = plot(epochs, 10*log10(mean(mseTrain_SCF).*scalingFactorSCF), 'Color', color1, 'LineWidth', 2, 'Parent', Ax(1));

load('C:\Users\marco\projects\TCC\main\Results\Convergence\Conv_Linear_64QAM_8Cp.mat');
...
% set(Ax(1), 'Box','off')
lgd = legend(Ax(1), [Y1 Y2 Y3 Y4], 'SCFNN - 64QAM 16CP', 'SCFNN - 64QAM 8CP', ...
                                    'RVNN - 64QAM 16CP', 'RVNN - 64QAM 8CP', 'Location', 'northeast');
