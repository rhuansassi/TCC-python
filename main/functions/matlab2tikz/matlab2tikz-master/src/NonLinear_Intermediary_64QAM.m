...
load('C:\Projects\tcc_v2\TCC\main\Results\30ns\NonLinear\NonLinear_64QAM_16Cp.mat');
...
load('C:\Projects\tcc_v2\TCC\main\Results\30ns\NonLinear\NonLinear_64QAM_8Cp.mat');
semilogy(EbNOdB(snrValues),LS_SER(snrValues),'--','Color', ["#2d3047"],'LineWidth',2.0);
hold on;
semilogy(EbNOdB(snrValues),LMMSE_SER(snrValues),'--','Color', ["#c4253b"],'LineWidth',2.0);
hold on;
...
matlab2tikz('IntermediaryNonLinear_64QAM.tex')