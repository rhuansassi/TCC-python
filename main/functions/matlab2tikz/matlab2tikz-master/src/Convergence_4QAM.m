...
% SCFNN
load('C:\Users\marco\projects\TCC\main\Results\Convergence\Conv_Linear_4QAM_16Cp.mat');
Y1 = plot(epochs, 10*log10(mean(mseTrain_SCF).*scalingFactorSCF), 'Color', color1, 'LineWidth', 2, 'Parent', Ax(1));

load('C:\Users\marco\projects\TCC\main\Results\Convergence\Conv_Linear_4QAM_8Cp.mat');
...
% set(Ax(1), 'Box','off')
lgd = legend(Ax(1), [Y1 Y2 Y3 Y4], 'SCFNN - 4QAM 16CP', 'SCFNN - 4QAM 8CP', ...
                                    'RVNN - 4QAM 16CP', 'RVNN - 4QAM 8CP', 'Location', 'northeast');
